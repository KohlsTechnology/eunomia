...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"./pkg/apis/eunomia/v1alpha1.GitOpsConfig":       schema_pkg_apis_eunomia_v1alpha1_GitOpsConfig(ref),
		"./pkg/apis/eunomia/v1alpha1.GitOpsConfigSpec":   schema_pkg_apis_eunomia_v1alpha1_GitOpsConfigSpec(ref),
		"./pkg/apis/eunomia/v1alpha1.GitOpsConfigStatus": schema_pkg_apis_eunomia_v1alpha1_GitOpsConfigStatus(ref),
	}
}
...
func schema_pkg_apis_eunomia_v1alpha1_GitOpsConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/eunomia/v1alpha1.GitOpsConfigSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/eunomia/v1alpha1.GitOpsConfigStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/eunomia/v1alpha1.GitOpsConfigSpec", "./pkg/apis/eunomia/v1alpha1.GitOpsConfigStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_eunomia_v1alpha1_GitOpsConfigSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"templateSource": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./pkg/apis/eunomia/v1alpha1.GitConfig"),
						},
					},
					"parameterSource": {
						SchemaProps: spec.SchemaProps{
					...
					"triggers": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("./pkg/apis/eunomia/v1alpha1.GitOpsTrigger"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"./pkg/apis/eunomia/v1alpha1.GitConfig", "./pkg/apis/eunomia/v1alpha1.GitOpsTrigger"},
	}
}
