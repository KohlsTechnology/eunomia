...
kubectl apply -f examples/hello-world-yaml/hello-world-cr1.yaml -n eunomia-hello-world-demo
...
kubectl apply -f examples/hello-world-yaml/hello-world-cr2.yaml -n eunomia-hello-world-demo
...
# We will simply point at an updated version of the CR for the demo
# In the real world this would a pull request to the existing yaml file
kubectl apply -f examples/hello-world-yaml/hello-world-cr3.yaml -n eunomia-hello-world-demo
