...
- [Operator SDK v0.18.2](https://github.com/operator-framework/operator-sdk/blob/v0.18.2/doc/user/install-operator-sdk.md)
...
Again, all the components (except operator-sdk v0.18.2 and golint) can be easily installed via Homebrew:
...
The components (except operator-sdk v0.18.2 and golint) can be installed via a distro-specific package manager. You can also download a binary, or install from source.
...
#### Installing operator-sdk v0.18.2 from GitHub release

The script `scripts/install-operator-sdk.sh ` will do this for you on Linux and MacOS:
```
scripts/install-operator-sdk.sh v0.18.2 /your/target/path
```
